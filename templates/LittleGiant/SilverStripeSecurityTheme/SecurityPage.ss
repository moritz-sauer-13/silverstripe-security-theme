...
<div class="w-full min-h-[calc(100svh-(var(--spacing)*25))] py-5 flex items-center justify-center"
     style="background-image: url($SiteConfig.LoginImage.FocusFill(2560,1440).Link); background-position: $SiteConfig.LoginImage.FocusPosition;">
  <div class="bg-white dark:bg-gray-800 dark:text-white p-5 md:p-8 lg:p-10 rounded-2xl shadow-lg flex flex-col gap-4">
